            ...
            <div class="col-xl-8 col-lg-7">
                <div class="service-details__left">
                    <div class="service-details__img">
                        <img src="assets/images/project/project-1-6.avif" alt="Fabric Nano Coating">
                    </div>
                    <h3 class="service-details__title-1">Fabric Nano Coating</h3>
                    <p class="service-details__text-1">Luxury fabric sofas, armchairs, and dining chairs add exquisite comfort to premium homes but are highly vulnerable to liquid spills, wine stains, dirt accumulation, and dust.</p>
                    <p class="service-details__text-2">Our advanced hydrophobic nano-coating creates an invisible, breathable molecular shield on each fabric fiber. Liquids bead up and roll off the surface, preventing deep stains while keeping the soft texture 100% unchanged.</p>
                    <ul class="service-details__points-list list-unstyled">
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Hydrophobic shield (liquids bead up and roll off)</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Prevents stains from tea, coffee, wine, and food spills</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>100% breathable protection; doesn't alter texture or look</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Long-lasting barrier that resists dust and wear</p>
                        </li>
                    </ul>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="service-details__img-box-single">
                                    <div class="service-details__img-box-img"><img src="assets/images/blog/blog-1-1.avif" alt="Liquid Repulsion"></div>
                                    <div class="service-details__img-box-content">
                                        <div class="service-details__img-box-content-icon-and-title">
                                            ...
                                            <h3 class="service-details__img-box-content-title">Liquid Repulsion</h3>
                                        </div>
                                        <p class="service-details__img-box-content-text">Liquids cannot penetrate the fibers, allowing you to easily blot spills away with a paper towel.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="service-details__img-box-single">
                                    <div class="service-details__img-box-img"><img src="assets/images/project/project-1-6.avif" alt="Soft & Breathable Care"></div>
                                    <div class="service-details__img-box-content">
                                        <div class="service-details__img-box-content-icon-and-title">
                                            <div class="service-details__img-box-content-icon">
                                                <span class="icon-review"></span>
                                            </div>
                                            <h3 class="service-details__img-box-content-title">Soft & Breathable</h3>
                                        </div>
                                        <p class="service-details__img-box-content-text">Maintains the original softness, feel, and color of the premium fabric, with zero stiffening.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="accrodion-grp" data-grp-name="faq-one-accrodion">
                                <div class="accrodion wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>Will the coating make my sofa fabric stiff or crusty?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Not at all. The nano-particles bond at a molecular level to individual fibers, preserving the fabric's original texture, softness, and breathability.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion active wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>How do I clean a liquid spill on coated fabric?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Simply use a dry, clean paper towel or microfiber cloth to blot the beaded liquid. Avoid rubbing; just let it absorb directly into the paper.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>How long does the nano-coating protection last?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Depending on usage and abrasion, the hydrophobic protective effect lasts between 1 to 2 years, after which a simple reapplication keeps the shield active.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="why-choose-two__left">
                    <div class="section-title text-left sec-title-animation animation-style2">
                        ...
                        <h2 class="section-title__title title-animation">Why Choose Us for Fabric Nano Coating</h2>
                    </div>
                    <p class="why-choose-two__text">Advanced hydrophobic shield to repel liquid spills and preserve luxury fabrics.</p>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single">
                                ...
                                <h3 class="why-choose-two__title">Hydrophobic Barrier</h3>
                                <p class="why-choose-two__single-text">Liquids sit as beads on the fabric surface instead of sinking in.</p>
                            </div>
                            <div class="why-choose-two__single">
                                <div class="why-choose-two__icon">
                                    <span class="icon-vacuum"></span>
                                </div>
                                <h3 class="why-choose-two__title">No Texture Change</h3>
                                <p class="why-choose-two__single-text">Maintains exactly the original soft feel of suede, velvet, or cotton.</p>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single-img">
                                <div class="why-choose-two__single-img-shape"></div>
                                <img src="assets/images/blog/blog-1-1.avif" alt="" style="border-radius: 12px; object-fit: cover; height: 350px; width: 100%;">
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single">
                                ...
                                <h3 class="why-choose-two__title">Odour & Dust Defense</h3>
                                <p class="why-choose-two__single-text">Repels household dust, pet dander, and liquid stains.</p>
                            </div>
                            <div class="why-choose-two__single">
                                <div class="why-choose-two__icon">
                                    <span class="icon-customer-review"></span>
                                </div>
                                <h3 class="why-choose-two__title">Breathable Protection</h3>
                                <p class="why-choose-two__single-text">Allows fabric to breathe normally without stiffening the fibers.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="before-and-after__img-box">
                        <div class="before-after">
                            <div class="before-after-twentytwenty" id="wrinkle-before-after">
                                <img src="assets/images/resources/fabric-before.avif"
                                    alt="Before Surface Protection">
                                <img src="assets/images/resources/fabric-after.avif"
