<?php
$pageTitle = "Dining Table Protection";
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="service-details__left">
                    ...
                    <h3 class="service-details__title-1">Dining Table Protection</h3>
                    <p class="service-details__text-1">Your dining table is where family gathers, making it highly vulnerable to acid stains from lemon juice, turmeric, wine, oil spills, and high-heat dishes. Our specialized TPU dining table protection film is designed to handle it all.</p>
                    <p class="service-details__text-2">Boasting industry-leading heat resistance and advanced self-healing qualities, our protective film shields luxury dining surfaces from direct heat up to 150°C and guarantees 100% stain prevention.</p>
                    <ul class="service-details__points-list list-unstyled">
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Industry-leading heat resistance (withstands hot plates)</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Complete protection against acid, wine, oil, and food stains</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Self-healing technology corrects minor surface scuffs</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Food-grade safe material, perfect for dining surfaces</p>
                        </li>
                    </ul>
                            ...
                            <div class="col-xl-6">
                                <div class="service-details__img-box-single">
                                    <div class="service-details__img-box-img">
                                        <img src="assets/images/services/ss-service-2-1.avif" alt="Heat & Acid Resistance">
                                    </div>
                                    <div class="service-details__img-box-content">
                                        <div class="service-details__img-box-content-icon-and-title">
                                            ...
                                            <h3 class="service-details__img-box-content-title">Heat & Acid Guard</h3>
                                        </div>
                                        <p class="service-details__img-box-content-text">Guards against coffee mugs, soup bowls, and acidic spills like citrus juice or red wine.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="service-details__img-box-single">
                                    <div class="service-details__img-box-img">
                                        <img src="assets/images/services/services-2-1.avif" alt="Self-Healing Top Coat">
                                    </div>
                                    <div class="service-details__img-box-content">
                                        <div class="service-details__img-box-content-icon-and-title">
                                            <div class="service-details__img-box-content-icon">
                                            ...
                                            <h3 class="service-details__img-box-content-title">Self-Healing TPU</h3>
                                        </div>
                                        <p class="service-details__img-box-content-text">Minor swirl marks and scuffs heal themselves when exposed to warmth, keeping the table brand new.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="accrodion-grp" data-grp-name="faq-one-accrodion">
                                <div class="accrodion wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>Can I place hot dining plates directly on it?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Yes. Our dining table protective film is built to handle temperatures up to 150°C, so standard hot plates and warm dishes will not damage the film.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion active wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>Is it safe for direct contact with food?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Yes, our films are made from high-grade, food-safe, non-toxic TPU material, making them perfectly safe for dining and food prep areas.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>Will turmeric or food coloring stain the film?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>No. The film has a highly dense, cross-linked polyurethane top coat that blocks micro-pores, ensuring stains like turmeric, curry, and wine wipe off easily without leaving marks.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="why-choose-two__left">
                    <div class="section-title text-left sec-title-animation animation-style2">
                        ...
                        <h2 class="section-title__title title-animation">Why Choose Us for Dining Table Protection</h2>
                    </div>
                    <p class="why-choose-two__text">Heat-resistant, stain-proof, and completely invisible shields for premium marble & wood tables.</p>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single">
                                ...
                                <h3 class="why-choose-two__title">Heat-Plate Shield</h3>
                                <p class="why-choose-two__single-text">Resists hot serving plates up to 120°C without bubbling.</p>
                            </div>
                            <div class="why-choose-two__single">
                                <div class="why-choose-two__icon">
                                    <span class="icon-vacuum"></span>
                                </div>
                                <h3 class="why-choose-two__title">Spill-Proof Barrier</h3>
                                <p class="why-choose-two__single-text">Protects marble from food colors, tea, wine, and citric acid.</p>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single-img">
                                <div class="why-choose-two__single-img-shape"></div>
                                <img src="assets/images/services/ss-service-2-1.avif" alt="" style="border-radius: 12px; object-fit: cover; height: 350px; width: 100%;">
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single">
                                ...
                                <h3 class="why-choose-two__title">Micro-Scratch Defense</h3>
                                <p class="why-choose-two__single-text">Blocks surface scratches from ceramic plates and key rings.</p>
                            </div>
                            <div class="why-choose-two__single">
                                <div class="why-choose-two__icon">
                                    <span class="icon-customer-review"></span>
                                </div>
                                <h3 class="why-choose-two__title">Mirror Finish</h3>
                                <p class="why-choose-two__single-text">Retains 100% of the natural stone mirror gloss.</p>
                            </div>
                        </div>
                    </div>
                </div>
