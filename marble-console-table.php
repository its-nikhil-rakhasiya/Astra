<?php
$pageTitle = "Marble Console Table";
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="service-details__left">
                    <div class="service-details__img">
                        <img src="assets/images/project/project-1-3.avif" alt="Marble Console Table Protection">
                    </div>
                    <h3 class="service-details__title-1">Marble Console Table Protection</h3>
                    <p class="service-details__text-1">Designer marble console tables in your entryway create the first impression of your home. However, keys, bags, coins, and flower vases placed on them can quickly cause scratch lines and water rings.</p>
                    <p class="service-details__text-2">Our specialized console protection film wraps the stone edge-to-edge, preventing daily wear while highlighting the natural color and vein patterns of the designer marble.</p>
                    <ul class="service-details__points-list list-unstyled">
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Edge-to-edge precision fit for designer console tables</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Excellent scratch protection from keys, bags, and daily items</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Waterproof barrier that prevents vase condensation rings</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Enriches natural stone color, depth, and vein visibility</p>
                        </li>
                    </ul>
                            ...
                            <div class="col-xl-6">
                                <div class="service-details__img-box-single">
                                    <div class="service-details__img-box-img">
                                        <img src="assets/images/services/ss-service-2-3.avif" alt="High-Impact Barrier">
                                    </div>
                                    <div class="service-details__img-box-content">
                                        <div class="service-details__img-box-content-icon-and-title">
                                            ...
                                            <h3 class="service-details__img-box-content-title">Impact Protection</h3>
                                        </div>
                                        <p class="service-details__img-box-content-text">Specially designed to absorb impacts from heavy keychains, metallic objects, and decor.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="service-details__img-box-single">
                                    <div class="service-details__img-box-img"><img src="assets/images/services/services-2-3.avif" alt="Water & Moisture Proof"></div>
                                    <div class="service-details__img-box-content">
                                        <div class="service-details__img-box-content-icon-and-title">
                                            <div class="service-details__img-box-content-icon">
                                                <span class="icon-review"></span>
                                            </div>
                                            <h3 class="service-details__img-box-content-title">Moisture Proof</h3>
                                        </div>
                                        <p class="service-details__img-box-content-text">Prevents damage from condensation from vases, plants, or spilled cosmetics and perfumes.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="accrodion-grp" data-grp-name="faq-one-accrodion">
                                <div class="accrodion wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>Will the film alter the unique look of my marble?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>No. The film is perfectly transparent and actually enhances the natural color depth and vein details of your premium marble console.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion active wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>Does it cover the carved edges of the table?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Our expert installers custom-cut and heat-seal the film to wrap smoothly over both flat surfaces and detailed edge profiles.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>Will it peel off easily on its own?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>No, we use premium, pressure-sensitive adhesive that stays securely in place but can be cleanly removed without residue when desired.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="why-choose-two__left">
                    <div class="section-title text-left sec-title-animation animation-style2">
                        ...
                        <h2 class="section-title__title title-animation">Why Choose Us for Console Table Protection</h2>
                    </div>
                    <p class="why-choose-two__text">Premium stone preservation for entryway consoles and delicate statement furniture.</p>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single">
                                ...
                                <h3 class="why-choose-two__title">Entry Key Defense</h3>
                                <p class="why-choose-two__single-text">Protects from sharp keys, keychains, and coins thrown on console.</p>
                            </div>
                            <div class="why-choose-two__single">
                                <div class="why-choose-two__icon">
                                    <span class="icon-vacuum"></span>
                                </div>
                                <h3 class="why-choose-two__title">Seamless Edge Fit</h3>
                                <p class="why-choose-two__single-text">Precision measured and cut to wrap standard or curved marble consoles.</p>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4">
                        ...
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single">
                                ...
                                <h3 class="why-choose-two__title">UV Fade Shield</h3>
                                <p class="why-choose-two__single-text">Blocks sunrays from yellowing or dulling premium marble stone.</p>
                            </div>
                            <div class="why-choose-two__single">
                                <div class="why-choose-two__icon">
                                    <span class="icon-customer-review"></span>
                                </div>
                                <h3 class="why-choose-two__title">Easy Dusting</h3>
                                <p class="why-choose-two__single-text">Repels household dust, making it extremely easy to wipe clean.</p>
                            </div>
                        </div>
                    </div>
                </div>
