<?php
$pageTitle = "Exterior Marble Wall Protection";
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="service-details__left">
                     <div class="service-details__img">
                        <img src="assets/images/project/project-1-7.avif" alt="Exterior Marble Wall Protection">
                    </div>
                    <h3 class="service-details__title-1">Exterior Marble Wall Protection</h3>
                    <p class="service-details__text-1">Preserve the premium look and longevity of your exterior marble claddings and walls. Outdoor stone surfaces are constantly exposed to UV radiation, acid rain, dust, and heavy atmospheric pollution. Our specialized protective films seal and guard these surfaces from environmental degradation.</p>
                    <p class="service-details__text-2">Using high-tensile, self-healing TPU technology, we add an ultra-durable invisible shield that rejects water, prevents moisture absorption, and protects your high-end exterior marble from cracking, chipping, staining, and fading over time.</p>
                    <ul class="service-details__points-list list-unstyled">
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>UV-resistant and weatherproof invisible protection</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Prevents moisture penetration and acid rain damage</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Self-healing technology for minor scratches and impacts</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Easy-clean surface that repels dust and environmental grime</p>
                        </li>
                    </ul>
                            ...
                            <div class="col-xl-6">
                                <div class="service-details__img-box-single">
                                    <div class="service-details__img-box-img">
                                        <img src="assets/images/services/ss-service-2-3.avif" alt="All-Weather Durability">
                                    </div>
                                    <div class="service-details__img-box-content">
                                        <div class="service-details__img-box-content-icon-and-title">
                                            ...
                                            <h3 class="service-details__img-box-content-title">All-Weather Durability</h3>
                                        </div>
                                        <p class="service-details__img-box-content-text">Tested to withstand extreme sun exposure, heavy rain, and thermal cycles without yellowing or peeling.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="service-details__img-box-single">
                                    <div class="service-details__img-box-img"><img src="assets/images/services/services-2-3.avif" alt="Premium Stone Preservation"></div>
                                    <div class="service-details__img-box-content">
                                        <div class="service-details__img-box-content-icon-and-title">
                                            <div class="service-details__img-box-content-icon">
                                                <span class="icon-review"></span>
                                            </div>
                                            <h3 class="service-details__img-box-content-title">Premium Stone Care</h3>
                                        </div>
                                        <p class="service-details__img-box-content-text">Ensures the natural grain and look of your expensive imported stone remain flawless for 5+ years.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="accrodion-grp" data-grp-name="faq-one-accrodion">
                                <div class="accrodion wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>How does the film protect against harsh weather?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Our specialized TPU film has advanced UV blockers and hydrophobic top coats that repel rain, prevent direct moisture absorption, and shield the marble from thermal expansion and contraction.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion active wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>Will it yellow or fade under direct sunlight?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>No. Our film is engineered with advanced UV stabilization technology to ensure it remains 100% optically clear and completely non-yellowing, backed by our multi-year warranty.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>Can it be applied to textured or rough marble?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>It is optimized for smooth, polished, or honed exterior stone claddings to achieve a perfect bubble-free adhesive bond.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="why-choose-two__left">
                    <div class="section-title text-left sec-title-animation animation-style2">
                        ...
                        <h2 class="section-title__title title-animation">Why Choose Us for Exterior Marble Protection</h2>
                    </div>
                    <p class="why-choose-two__text">Weather-proof, dust-repellent, and UV-resistant defense for exterior marble panels.</p>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single">
                                ...
                                <h3 class="why-choose-two__title">Weather-Proof TPU</h3>
                                <p class="why-choose-two__single-text">Withstands direct harsh sun, rain, and thermal expansion.</p>
                            </div>
                            <div class="why-choose-two__single">
                                <div class="why-choose-two__icon">
                                    <span class="icon-vacuum"></span>
                                </div>
                                <h3 class="why-choose-two__title">Anti-Soiling Shield</h3>
                                <p class="why-choose-two__single-text">Prevents rain stains, dust accumulation, and soot marking on stone.</p>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single-img">
                                <div class="why-choose-two__single-img-shape"></div>
                                <img src="assets/images/services/ss-service-2-3.avif" alt="" style="border-radius: 12px; object-fit: cover; height: 350px; width: 100%;">
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single">
                                ...
                                <h3 class="why-choose-two__title">UV Damage Block</h3>
                                <p class="why-choose-two__single-text">Stops marble panels from turning yellow or fading under sunlight.</p>
                            </div>
                            <div class="why-choose-two__single">
                                <div class="why-choose-two__icon">
                                    <span class="icon-customer-review"></span>
                                </div>
                                <h3 class="why-choose-two__title">Long-Term Warranty</h3>
                                <p class="why-choose-two__single-text">Provides deep, weather-tight exterior durability for 5+ years.</p>
                            </div>
                        </div>
                    </div>
                </div>
