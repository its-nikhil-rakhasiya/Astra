            ...
            <div class="col-xl-8 col-lg-7">
                <div class="service-details__left">
                    <div class="service-details__img">
                        <img src="assets/images/services/door_ss_strip_main.avif" alt="Door SS Strip Wrap">
                    </div>
                    <h3 class="service-details__title-1">Door SS Strip & Metallic Accent Protection</h3>
                    <p class="service-details__text-1">Luxury entrance and interior designer doors are often styled with elegant stainless steel (SS) strips, brass trims, handles, and premium metallic accents. However, these reflective surfaces are highly prone to fingerprint marks, smudges, friction scratches from keys/rings, and oxidation due to moisture. Our precision metal protection film provides a clean, long-lasting defense.</p>
                    <p class="service-details__text-2">Measured and custom-cut to match your door's exact metallic details, the protective film adheres perfectly to metal. It rejects oil and fingerprints completely, absorbs micro-abrasions, prevents weathering, and keeps your premium door details looking polished and brand new.</p>
                    <ul class="service-details__points-list list-unstyled">
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Precision fit custom-cut to match delicate SS and brass strips</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>100% smudge-proof and fingerprint repellent surface finish</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Superior scratch protection from keys, rings, bags, and daily wear</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Prevents metal oxidation, corrosion, and weathering from moisture</p>
                        </li>
                    </ul>
                            ...
                            <div class="col-xl-6">
                                <div class="service-details__img-box-single">
                                    <div class="service-details__img-box-img">
                                        <img src="assets/images/services/door_metal_smudge_free.avif" alt="Smudge Free Metals">
                                    </div>
                                    <div class="service-details__img-box-content">
                                        <div class="service-details__img-box-content-icon-and-title">
                                            ...
                                            <h3 class="service-details__img-box-content-title">Smudge-Free</h3>
                                        </div>
                                        <p class="service-details__img-box-content-text">Keeps premium door metal and handles completely free from oily fingerprint stains for a neat, welcoming entrance.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="service-details__img-box-single">
                                    <div class="service-details__img-box-img">
                                        <img src="assets/images/services/door_metal_oxidation_shield.avif" alt="Corrosion and Oxidation Shield">
                                    </div>
                                    <div class="service-details__img-box-content">
                                        <div class="service-details__img-box-content-icon-and-title">
                                            <div class="service-details__img-box-content-icon">
                                            ...
                                            <h3 class="service-details__img-box-content-title">Oxidation Shield</h3>
                                        </div>
                                        <p class="service-details__img-box-content-text">Protects metallic details against moisture and cleaning water, preventing rust, tarnish, and color fading.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="accrodion-grp" data-grp-name="faq-one-accrodion">
                                <div class="accrodion wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>Is the film custom-cut for the exact width of my door's metallic strips?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Yes. Our professional installation team takes exact millimeter measurements of your door's stainless steel or brass design strips. The film is pre-cut with absolute precision to match the custom shapes and widths, guaranteeing a neat and seamless look.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion active wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>Will constant door-opening and touching cause the film edges to curl?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>No. We use premium films with advanced edge-seal adhesion technology. Once professionally bonded to the metallic surfaces, the film remains perfectly secure and flat, resisting constant physical contact and environmental temperature fluctuations without peeling or lifting.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>Can the protective wrap be removed in the future without damaging the metal finish?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Absolutely. The film features clean-peel adhesive technology. If you ever decide to remove or replace the film, it will lift off effortlessly without leaving behind any sticky glue residue, protecting the delicate metallic sheen and lacquer underneath.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="why-choose-two__left">
                    <div class="section-title text-left sec-title-animation animation-style2">
                        ...
                        <h2 class="section-title__title title-animation">Why Choose Us for Door SS Strip Protection</h2>
                    </div>
                    <p class="why-choose-two__text">Custom-cut metallic accents protection against fingernail smudges and oxidation.</p>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single">
                                ...
                                <h3 class="why-choose-two__title">Custom Strip Cuts</h3>
                                <p class="why-choose-two__single-text">Measured and cut to perfectly wrap thin, delicate metal door strips.</p>
                            </div>
                            <div class="why-choose-two__single">
                                <div class="why-choose-two__icon">
                                    <span class="icon-vacuum"></span>
                                </div>
                                <h3 class="why-choose-two__title">No Fingerprint Marks</h3>
                                <p class="why-choose-two__single-text">Eliminates constant polishing of reflective brass and SS strips.</p>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single-img">
                                <div class="why-choose-two__single-img-shape"></div>
                                <img src="assets/images/services/door_ss_strip_main.avif" alt="" style="border-radius: 12px; object-fit: cover; height: 350px; width: 100%;">
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single">
                                ...
                                <h3 class="why-choose-two__title">Oxidation Guard</h3>
                                <p class="why-choose-two__single-text">Seals the metal from humidity, preventing corrosion and staining.</p>
                            </div>
                            <div class="why-choose-two__single">
                                <div class="why-choose-two__icon">
                                    <span class="icon-customer-review"></span>
                                </div>
                                <h3 class="why-choose-two__title">High Scratch Defense</h3>
                                <p class="why-choose-two__single-text">Guards against key scratches, ring abrasions, and bag bumps.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="before-and-after__img-box">
                        <div class="before-after">
                            <div class="before-after-twentytwenty" id="wrinkle-before-after">
                                <img src="assets/images/resources/door-before.avif"
                                    alt="Before Surface Protection">
                                <img src="assets/images/resources/door-after.avif"
