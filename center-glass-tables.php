            ...
            <div class="col-xl-8 col-lg-7">
                <div class="service-details__left">
                    <div class="service-details__img">
                        <img src="assets/images/project/project-1-5.avif" alt="Center Glass Tables Protection">
                    </div>
                    <h3 class="service-details__title-1">Center Glass Tables Protection</h3>
                    <p class="service-details__text-1">Glass center tables are the central focal point of any premium living area, but they are highly prone to unsightly micro-scratches, smudges, and rings from daily items. Our premium optical-grade glass films provide a robust, completely invisible barrier.</p>
                    <p class="service-details__text-2">Engineered to be 100% transparent, the film retains the high gloss of your glass without distorting clarity. It absorbs daily impacts, resists fingerprints, and makes glass surfaces incredibly easy to maintain.</p>
                    <ul class="service-details__points-list list-unstyled">
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>100% optical clarity with high-gloss surface shine</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Exceptional scratch resistance from keys, cups, and decor</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Fingerprint and smudge resistant hydrophobic surface</p>
                        </li>
                        <li>
                            <div class="icon">
                                <span class="icon-check-1"></span>
                            </div>
                            <p>Safe and clean removal without leaving adhesive residue</p>
                        </li>
                    </ul>
                            ...
                            <div class="col-xl-6">
                                <div class="service-details__img-box-single">
                                    <div class="service-details__img-box-img">
                                        <img src="assets/images/services/ss-service-2-4.avif" alt="Impact & Scratch Proof">
                                    </div>
                                    <div class="service-details__img-box-content">
                                        <div class="service-details__img-box-content-icon-and-title">
                                            ...
                                            <h3 class="service-details__img-box-content-title">Impact & Scratch Proof</h3>
                                        </div>
                                        <p class="service-details__img-box-content-text">Blocks micro-abrasions from ceramic cups, metal items, and regular decor placement on your table.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="service-details__img-box-single">
                                    <div class="service-details__img-box-img">
                                        <img src="assets/images/services/services-2-4.avif" alt="Pristine Shine Retention">
                                    </div>
                                    <div class="service-details__img-box-content">
                                        <div class="service-details__img-box-content-icon-and-title">
                                            <div class="service-details__img-box-content-icon">
                                            ...
                                            <h3 class="service-details__img-box-content-title">Pristine Shine</h3>
                                        </div>
                                        <p class="service-details__img-box-content-text">Maintains a clean, crystal-clear, and polished glass appearance at all times with minimal wiping.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="accrodion-grp" data-grp-name="faq-one-accrodion">
                                <div class="accrodion wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>Is the film visible on the glass table?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Not at all. Once professionally installed, the film is completely clear and optically invisible, maintaining the exact gloss and transparency of your glass.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion active wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>How do I clean a protected glass table?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>You can simply wipe it clean with a soft microfiber cloth and a mild soap-water solution. Avoid harsh abrasives or strong chemical cleaners.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                    <div class="accrodion-title">
                                        <h4>Will it protect against glass cracking?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Yes, it provides strong structural reinforcement that helps distribute impact energy, reducing the risk of shattering and holding glass pieces together if broken.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="why-choose-two__left">
                    <div class="section-title text-left sec-title-animation animation-style2">
                        ...
                        <h2 class="section-title__title title-animation">Why Choose Us for Center Glass Table Protection</h2>
                    </div>
                    <p class="why-choose-two__text">Optically transparent, smudge-proof, and self-healing shields for living room center glass.</p>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single">
                                ...
                                <h3 class="why-choose-two__title">Optically Clear</h3>
                                <p class="why-choose-two__single-text">Completely invisible film that retains crystal-clear glass transparency.</p>
                            </div>
                            <div class="why-choose-two__single">
                                <div class="why-choose-two__icon">
                                    <span class="icon-vacuum"></span>
                                </div>
                                <h3 class="why-choose-two__title">Anti-Smudge</h3>
                                <p class="why-choose-two__single-text">Hydrophobic layer that rejects fingerprint oils and daily smudges.</p>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single-img">
                                <div class="why-choose-two__single-img-shape"></div>
                                <img src="assets/images/services/ss-service-2-4.avif" alt="" style="border-radius: 12px; object-fit: cover; height: 350px; width: 100%;">
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4">
                            <div class="why-choose-two__single">
                                ...
                                <h3 class="why-choose-two__title">Ring-Mark Shield</h3>
                                <p class="why-choose-two__single-text">Prevents permanent water ring marks from cups and glasses.</p>
                            </div>
                            <div class="why-choose-two__single">
                                <div class="why-choose-two__icon">
                                    <span class="icon-customer-review"></span>
                                </div>
                                <h3 class="why-choose-two__title">Impact Cushion</h3>
                                <p class="why-choose-two__single-text">Protects delicate tempered glass from heavy daily ornaments.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="before-and-after__img-box">
                        <div class="before-after">
                            <div class="before-after-twentytwenty" id="wrinkle-before-after">
                                <img src="assets/images/resources/glass-before.avif"
                                    alt="Before Surface Protection">
                                <img src="assets/images/resources/glass-after.avif"
